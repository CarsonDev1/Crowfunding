...
function SignUp() {
	...
	return (
		<LayoutAuthentication heading="Sign Up">
			...
			<button className="flex items-center justify-center w-full py-4 mb-5 text-base font-semibold border rounded-lg gap-x-3 border-strock text-text2 dark:text-white dark:border-darkStroke">
